      ...
      then: (schema) =>
        schema
          ...
          .test("expiry-date", "Your card validity has expired", function (value) {
            ...
            const expDate = new Date(`20${yy}`, mm); // First day of next month
            const now = new Date();
            return expDate > now;
          }),
    }),
...
const OwnerPayment = () => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      if (res.paymentStatus === "completed") {
        ...
        navigate("/owner/viewProperty"); // Adjust the path as needed
      } else {
  ...
  return (
    <div className="container mx-auto p-6">
      <h2 className="text-3xl font-bold mb-4">Owner Subscription Payment</h2>
            ...
            return (
              <Form>
                <div className="mb-4">
                  ...
                  <ErrorMessage name="selectedPlan" component="div" className="text-red-500 text-sm" />
                </div>
                ...
                {["credit-card", "debit-card"].includes(values.paymentMethod) && (
                  <div className="mb-4">
                    ...
                    <div className="flex gap-2">
                      <ErrorMessage name="expiry" component="div" className="text-red-500 text-sm w-1/2" />
                      <ErrorMessage name="cvv" component="div" className="text-red-500 text-sm w-1/2" />
                    </div>
                  </div>
                )}
