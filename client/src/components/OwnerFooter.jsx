  ...
  return (
    <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-12">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        {/* About Section */}
        <div>
          <h2 className="text-xl font-bold text-blue-400">EstateHub Owners</h2>
          <p className="text-gray-400 mt-3 text-sm leading-relaxed">
            Manage and list your properties seamlessly. EstateHub provides the best platform 
            for property owners to reach potential buyers and tenants.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div>
            ...
            <ul className="space-y-2 text-center md:text-left">
              <li><Link to="/owner/home" className="text-gray-400 hover:text-blue-400 transition">Home</Link></li>
              <li><Link to="/owner/viewproperty" className="text-gray-400 hover:text-blue-400 transition">My Properties</Link></li>
              <li><Link to="/owner/notifications" className="text-gray-400 hover:text-blue-400 transition">Messages</Link></li>
      ...
      <div className="border-t border-gray-700 mt-8 pt-6 text-center">
        <p className="text-sm text-gray-400">
          © 2025 EstateHub Owners. All Rights Reserved | Managed by 
